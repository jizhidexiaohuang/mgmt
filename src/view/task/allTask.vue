    ...
    <div class="have-drawer-style">
        <div class="card-style">
            ...
            <Row class="header-common-right-box">
                <Col style="float:left;">
                    <Button type="primary" @click="createTask" v-if="false">创建任务</Button>
                </Col>
                <!-- 筛选项 -->
            ...
            <Row style="border:1px solid #dcdee2;border-bottom:0;">
                ...
                <template slot-scope="{ row, index }" slot="action">
                    <Dropdown @on-click="option(row.id,$event)" v-permission="['mission:all:manage-']">
                        ...
                        <DropdownMenu slot="list">
                            ...
                            <DropdownItem name="publish" v-show="getMissionState(row.state,'publish')" v-permission="['mission:audit-']">发布</DropdownItem>
                            <DropdownItem name="publish-P" v-show="getMissionState(row.state,'publish-P')" v-permission="['mission:audit-',false]">发布</DropdownItem>
                            <DropdownItem name="reject" v-show="getMissionState(row.state,'reject')" v-permission="['mission:audit-']">驳回</DropdownItem>
        ...
        <Drawer 
            ...
            <div slot="header" class="drawer-title">
                ...
                <Dropdown transfer @on-click="option(taskDetail.id,$event)" class="edit-icon" v-if="isInfo" v-permission="['mission:all:manage-']">
                    <a href="javascript:void(0)">
                        <Icon type="ios-more" size="20"/>
                    </a>
                    <DropdownMenu slot="list">
                        ...
                        <DropdownItem name="reject" v-permission="['mission:audit-']" v-show="getMissionState(taskDetail,'reject')">驳回</DropdownItem>
