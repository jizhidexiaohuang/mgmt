    ...
    <div class="have-drawer-style">
        <div class="card-style">
            ...
            <Drawer 
                ...
                <contract-info v-if="isInfo && addDrawerCtrl" :defaultData="contractDetail"></contract-info>
            </Drawer>
        </div>
        ...
        <Modal
            ...
            :width="360"
            :footer-hide="true">
            <Row class="modal-tips">请问是否同意通过本合同？</Row>
...
export default {
    ...
    methods: {
        ...
        clearConditions(){
            ...
            this.searchForm.state = "PR";
            this.searchForm.createStartDate = "";
            this.searchForm.createEndDate = "";
            this.createTime = [];
            this.$refs.creatorSelect.clearSelected();
            this.reloadTable();
        },
        option(id,name){
            this.id = id;
        ...
        agreeSubmit(){
            let url = `/base/contract/${this.id}/audit`;
