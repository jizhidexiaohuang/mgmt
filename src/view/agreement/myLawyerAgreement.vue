    ...
    <div class="have-drawer-style">
            ...
            <Row style="border:1px solid #dcdee2;border-bottom:0;">
                <Table :columns="columns" :data="data" :loading="tableLoading">
                    <template slot-scope="{ row, index }" slot="action">
                        <Dropdown @on-click="option(row.id,$event,row.name)" v-permission="['agreement:lawyer:my:manage-']">
        ...
        <Drawer 
            ...
            <div slot="header" class="drawer-title">
                ...
                <Dropdown transfer @on-click="option(agreementDetail.id,$event,agreementDetail.name)" v-if="isInfo" class="edit-icon" v-permission="['agreement:lawyer:my:manage-']">
                    <a href="javascript:void(0)">
                        <Icon type="ios-more" size="20"/>
                    </a>
                    <DropdownMenu slot="list">
...
export default {
    ...
    methods: {
        ...
        getData(){
            let url = '/settlement/agreement-price-lawyers/my';
            let ajaxData = {
