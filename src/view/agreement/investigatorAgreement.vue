    ...
    <div class="have-drawer-style">
        <div class="card-style">
            <Row class="header-common-right-box">
                <Col style="float:left;">
                    <Button @click="openAddDrawer" v-if="false" type="primary">新增调查协议</Button>
                </Col>
                <!-- 筛选项 -->
            ...
            <Row style="border:1px solid #dcdee2;border-bottom:0;">
                <Table :columns="columns" :data="data" :loading="tableLoading">
                    <template slot-scope="{ row, index }" slot="action">
                        <Dropdown @on-click="option(row.id,$event)" v-permission="['agreement:investigator:all:mange-']">
        ...
        <Drawer 
            ...
            <div slot="header" class="drawer-title">
                ...
                <Dropdown transfer @on-click="option(investAgreementDetail.id,$event)" v-if="isInfo" class="edit-icon" v-permission="['agreement:investigator:all:mange-']">
                    <a href="javascript:void(0)">
                        <Icon type="ios-more" size="20"/>
                    </a>
                    <DropdownMenu slot="list">
                        ...
                        <DropdownItem name="reject" v-show="investAgreementDetail.state=='P'">驳回</DropdownItem>
                        <DropdownItem name="copy">复制</DropdownItem>
                    </DropdownMenu>
                </Dropdown>
            </div>
...
export default {
    ...
    methods: {
        ...
        getData(){
            let url = '/settlement/agreement-price-investigators';
            let ajaxData = {
