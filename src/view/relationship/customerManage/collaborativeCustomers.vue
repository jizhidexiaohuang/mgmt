        ...
        <div class="card-style">
            ...
            <Row class="header-common-right-box">
                <Col style="float:left;">
                    ...
                    <Button @click="addDrawerCtrl=true" type="primary">新增客户</Button> -->
                    <Dropdown @on-click="exportOption" v-permission="['market-center:customer:all:export-']">
                ...
                <Col class="filter-col search-box">
                    ...
                    <div class="container" v-show="searchBoxCtrl">
                        ...
                        <Row class="header-common-right-box">
                            ...
                            <Col span="18">
                                <DatePicker v-model="cooperationDate" type="daterange" placement="bottom-end" placeholder="请选择时间" @on-change="getTime" style="width:190px"></DatePicker>
                            </Col>
                        </Row>
                        <Row class="header-common-right-box">
                            <Col span="6" class="header-common-col">
            ...
            <Row style="border:1px solid #dcdee2;border-bottom:0;">
                <checkbox-table :columns="columns" :data="customeList" ref="checkboxTable"
                    ...
                    <template slot-scope="{ row, index }" slot="more-actions">
                        <Dropdown @on-click="option(row,$event)" v-permission="['market-center:customer:cooperation:manage-']">
        ...
        <Drawer 
            ...
            <div slot="header" class="drawer-title">
                ...
                <Dropdown transfer @on-click="option({id:id},'termination')" class="edit-icon"  
                    v-if="custCoopProgress&&custCoopProgress.indexOf('T')===-1" v-permission="['market-center:customer:cooperation:manage-']">
                    <a href="javascript:void(0)">
                        <Icon type="ios-more" size="20"/>
                    </a>
                    <DropdownMenu slot="list">
