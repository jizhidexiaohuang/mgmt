    ...
    <div>
        ...
        <div class="manage-content">
            ...
            <Row v-if="tabsActive==='customerInfo'" class="info-tabs">
                ...
                <customerInfo v-if="!isEditDetail&&tabsActive==='customerInfo'&&detail" :customerDetail="detail" v-on="$listeners"></customerInfo>
                <editCustomer v-if="isEditDetail&&tabsActive==='customerInfo'" :customerDetail="detail" @changeEdit="getDetail"></editCustomer>
            </Row>
            <!-- 沟通计划 -->
...
import customerInfo from "@/view/relationship/customerManage/customerInfo";
