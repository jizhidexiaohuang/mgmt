        ...
        <div class="card-style">
            ...
            <Row class="header-common-right-box">
                <Col style="float:left;">
                    <Button v-permission="['market-center:channel:my:manage-']" @click="addDrawerCtrl=true" type="primary">新增渠道</Button>
                    <Button v-permission="['market-center:channel:my:manage-']" :disabled="idList.length==0" @click="transferCustomerCtrl=true">转移</Button>
                </Col>
                <!-- 筛选项 -->
            ...
            <Row style="border:1px solid #dcdee2;border-bottom:0;">
                <checkbox-table :columns="columns" :data="customeList" ref="checkboxTable"
                    ...
                    <template slot-scope="{ row, index }" slot="more-actions">
                        <Dropdown @on-click="option(row,$event)" v-permission="['market-center:channel:my:manage-']">
        ...
        <Drawer 
            ...
            <div slot="header" class="drawer-title">
                ...
                <Dropdown transfer @on-click="option({id:id},'termination')" class="edit-icon"  
                    v-if="custCoopProgress&&custCoopProgress.indexOf('T')===-1" v-permission="['market-center:channel:my:manage-']">
                    <a href="javascript:void(0)">
                        <Icon type="ios-more" size="20"/>
                    </a>
                    <DropdownMenu slot="list">
