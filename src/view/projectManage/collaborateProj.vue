<template>
    <div class="have-drawer-style project-box">
        <div class="card-style">
            ...
            <!-- 表格 -->
            <Row v-if="!infoCtrl" style="border:1px solid #dcdee2;border-bottom:0;">
                <Table :columns="columns" :data="data" row-key="id" :loading="tableLoading">
                </Table>
            </Row>
...
export default {
    ...
    methods: {
        //获取列表数据
        getData(){
            let url = '/business/projects/help';
            let ajaxData = {
