...
export default {
    ...
    created(){},
    activated(){
        if(this.$route.query.bagId){
            this.getData('tabs-6','AO',{bagId:this.$route.query.bagId});
        }else{
