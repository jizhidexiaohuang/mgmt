                ...
                <li @click="changeTableColumns('PG')" :class="isSelected==='PG'?'active':''">
                    ...
                    <Poptip trigger="click" style="width:100%;" transfer placement="bottom-start">
                        ...
                        <CheckboxGroup @on-change="changePendding" v-model="penddingArr">
                            ...
                            <Checkbox label="isPendingReconcile"><span>和解待审核({{sumData.pendingReconcileNumber || 0}})</span></Checkbox>
                        </CheckboxGroup>
                        </div>
                    </Poptip>
                </li>
...
export default {
    ...
    methods: {
        ...
        //获取列表数据
        getData(){
            let url = '/business/case/my/criminal';
            let ajaxData = {
        ...
        //获取字典数据接口
        async getDictionary(){
            this.caseProgressArr = await this.common.getDictionaryItems('case_progress_criminal');
